    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-center text-gray-600 mb-6">
                Wkrótce pojawi się tutaj formularz rejestracji.
            </p>
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" id="confirm-password" name="confirm-password" disabled className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed" />
                </div>
